...
const poi = {
  ...
  "riconoscersifragildisturba": {
    name: "riconoscersi attimi sospesi di fragilità in divenire disturba",
    id: "riconoscersifragildisturba",
    x: 28,
    y: 7,
    poi: true,
    exhibit: true,
